...
#we select 4 as thats the point in which we can see the "elbow"

set.seed(123) #for reproducibility
#Silhouette Method for further analysis
fviz_nbclust(pca_clusters_data, kmeans, method = "silhouette") +
  labs(subtitle = "Silhouette method")
#for the hierarchical method we will be using 3 clusters as thats the point is shown in the silhouette plot

km_res <- kmeans(pca_clusters_data, centers = 4, nstart = 25) #as explained earlier 4 centers, and 25 iterations just in case
